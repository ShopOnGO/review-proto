...
func (x *AddQuestionRequest) GetProductVariantId() int64 {
	if x != nil {
...
func (x *AddQuestionRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *GetQuestionsRequest) GetProductVariantId() int64 {
	if x != nil {
		return x.ProductVariantId
	}
	return 0
...
var file_questions_proto_rawDesc = string([]byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x70, 0x72, 0x6f, 0x64, 0x75,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x56, 0x61, 0x72,
